...
const Main = () => {
  return (
    <div id="home" className=" min-h-screen bg-[#17213A] w-full flex flex-col md:flex-row items-center justify-center space-x-0 md:space-x-10 space-y-20 md:space-y-0">
      <div className="w-full md:w-[700px] mt-10 md:mt-32 px-4">
